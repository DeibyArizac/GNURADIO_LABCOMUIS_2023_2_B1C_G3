...
from CalculoPotenciaJ1C import CalculoPotenciaJ1C  # grc-generated hier_block
...
from lab3a import lab3a  # grc-generated hier_block



from gnuradio import qtgui

class ModuladorAmplitudVG3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModuladorAmplitudVG3")
        ...
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "coheficiente de sencibilidad AM", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.CalculoPotenciaJ1C_0 = CalculoPotenciaJ1C(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotenciaJ1C_0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.lab3a_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.CalculoPotenciaJ1C_0, 0))
        self.connect((self.lab3a_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.lab3a_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.lab3a_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.lab3a_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.lab3a_0.set_Ac(self.Ac)




def main(top_block_cls=ModuladorAmplitudVG3, options=None):
