...
class Lab_comu_1_Grupo_B1C(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Primer Flujorama", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Primer Flujorama")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comu_1_Grupo_B1C")
        ...
        self._Amplitude_range = Range(-1, 1, 1, 0, 200)
...
def main(top_block_cls=Lab_comu_1_Grupo_B1C, options=None):
